...
![Codex Loop Engineering 中文架构图](assets/codex-loop-engineering-architecture-zh.png)

![Codex Loop Engineering 中文产物流程图](assets/codex-loop-engineering-artifacts-zh.png)
